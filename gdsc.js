window.addEventListener('load', () => {
    ...
    const task_updates=document.createElement('button');
    task_updates.classList.add('update');
    task_updates.innerText='Task Complete';
    task_updates.style.color='#34A853';

		task_actions_el.appendChild(task_edit);
		task_actions_el.appendChild(task_delete_el);
    task_actions_el.appendChild(task_updates);
